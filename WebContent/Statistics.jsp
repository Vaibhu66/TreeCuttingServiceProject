...
<body>
    ...
    <div class="container" id="Stat">
        ...
        <br>
        <form id="StatisticsForm" action="ClientSummary" method="post">
            <div class="container">
            <div class="col text-center">
                <button class="btn btn-primary" onclick="toggleTable()">Statistics</button>
            </div>
		<br>
        <div id="lstat">
        <br>
            <table id="Statisticslist" class="table table-bordered table-striped">
                <c:if test="${listClientSummary != null}">
                <thead>
                    			<tr>
				<th>Client ID</th>
				<th>First Name</th>
   ...
   <script>
    $(document).ready(function() {
        $("#lstat").click(function() {
            $("#Statisticslist").toggle();
        });
