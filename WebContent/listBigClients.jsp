...
<body>
    ...
    <div class="container" id="BigC">
        ...
        <br>
        <form id="bigClientsForm" action="listBigClient" method="post">
            <div class="container">
            <div class="col text-center">
                <button class="btn btn-primary" onclick="toggleTable()">List Big Clients</button>
            </div>
		<br>
        <div id="lBC">
        <br>
            <table id="BigClientsList" class="table table-bordered table-striped">
                <c:if test="${listBigClient != null}">
                <thead>
                    <tr>
                        <th>Client ID</th>
                        <th>First Name</th>
                ...
                <tbody>
                    <c:forEach var="bigclnt" items="${listBigClient}">
                        <tr style="text-align: center">
                            <td><c:out value="${bigclnt.clientID}" /></td>
                            <td><c:out value="${bigclnt.firstName}" /></td>
                            <td><c:out value="${bigclnt.lastName}" /></td>
                            <td><c:out value="${bigclnt.address}" /></td>
                            <td><c:out value="${bigclnt.phoneNumber}" /></td>
                            <td><c:out value="${bigclnt.email}" /></td>
                            <td><c:out value="${bigclnt.numberOfTrees}" /></td>
                        </tr>
                    </c:forEach>
                </tbody>
                </c:if>
