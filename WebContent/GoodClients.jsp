...
<body>
    ...
    <div class="container" id="GoodC">
        ...
        <br>
        <form id="GoodClientsForm" action="GoodClients" method="post">
            <div class="container">
            <div class="col text-center">
                <button class="btn btn-primary" onclick="toggleTable()">List Good Clients</button>
            </div>
		<br>
        <div id="lGoC">
        <br>
            <table id="GoodClientsList" class="table table-bordered table-striped">
                <c:if test="${listGoodClients != null}">
                <thead>
                    			<tr>
				<th>Client ID</th>
				<th>First Name</th>
