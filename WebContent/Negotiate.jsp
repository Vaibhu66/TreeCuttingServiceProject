...
<head>
    ...
    <title>Negotiate Dashboard for David</title>
...
<body>
    <div class="container" id="David">
        ...
        <div class="text-center mt-3">
            <a href="david_smith_dashboard.jsp" class="btn btn-primary">Back</a>
        </div>
        <br>
        <form action="editQuoteDavid" method="post" id="QuoteTab">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="price" value="${quote.price}" />
                        </td>
                        <td>
                            <!-- Editable input field for Status -->
                            <input type="text" name="status" value="${quote.status}" />
                        </td>
                        <td>
                            <!-- Editable input field for Note -->
                            <input type="text" name="note" value="${quote.note}" />
                        </td>
